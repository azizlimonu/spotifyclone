  ...
  return (
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal>
        ...
        >
          <Dialog.Content
            className='fixed drop-shadow-md border border-neutral-700 left-[50%] top-[50%] max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[450px] translate-x-[-50%] translate-y-[-50%] bg-neutral-800 rounded-md focus:outline-none p-[25px]'
          >
            <Dialog.Title
